...
def result(request):
    ...
    dataset = pd.read_csv(r"D:\Projek_Python\Projek-Skripsi-Full-2\dkp\media\files\data.csv")
...
def export_csv(request):
    ...
    response['Content-Disposition'] = 'attachment; filename=data_testing_k-nearest_neiighbor=9.csv'
    return response
...
def export_xls(request):
    ...
    response['Content-Disposition'] = 'attachment; filename=data_testing_k-nearest_neiighbor=9.xls'
    return response
