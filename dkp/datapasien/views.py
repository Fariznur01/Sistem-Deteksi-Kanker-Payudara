...
#berfungsi menampilkan data yang terdapat pada model kepada tampilan template
from .models import Basis

#berfungsi memasukan form input dari file .forms
...
#views berfungsi untuk membuat fungsi-fungsi seperti CRUD
# Create your views here.
@login_required(login_url=settings.LOGIN_URL)
def datapasien(request):
    #Jika ingin mencari info data maka masuk ke if kalo tidak ada masuk else menampilkan semua data
    if request.POST:
...
def tambah(request):
    ...
    # ada suatu data yang dikirim user
...
def update(request, update_id):
    ...
    #Objek kelas memakai form yang sama dengan fungsi tambah
